import './acceptSVG.css';

const AcceptSVG = ({clazz, f}) => {

    const imgClass = 'accept ' + clazz
    return (
        <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
            width="800px" height="800px" viewBox="0 0 1280.000000 1253.000000"
            preserveAspectRatio="xMidYMid meet" className={imgClass}>
